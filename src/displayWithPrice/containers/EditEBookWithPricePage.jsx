...
import ModifiedFormEditEBookWithPrice from '../components/ModifiedFormEditEBookWithPrice';
import getEBookById from '../services/getEBookById';
import { notifyError } from "@/commons/utils/toaster";

const EditEBookWithPricePage = props => {
  const { id } = useParams();
  ...
  useEffect(() => {
    setTitle("Edit EBook with Price");
  ...
  return (
    <Layouts.ViewContainerLayout>
      <Layouts.FormContainerLayout
        singularName={"EBook"}
      >
        <ModifiedFormEditEBookWithPrice
          eBookData={eBookData}
          isLoading={isLoading}
          {...props}
        />
...
export default EditEBookWithPricePage;